platform "fedora-28-x86_64" do |plat|
  ...
  plat.provision_with "/usr/bin/dnf install -y --best --allowerasing autoconf automake rsync gcc make rpmdevtools rpm-libs which"
  ...
  plat.base_docker_image "fedora:28"
end
